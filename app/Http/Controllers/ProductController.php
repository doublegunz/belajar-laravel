...
class ProductController extends Controller
{
    ...
    {
        //query se;ect berdasarkan id
        $products = Product::findOrFail($id);
        //cek apakah field photo tidak null / kosong
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('photo')) {
                //cek, jika photo tidak kosong maka file yang ada difolder uploads/product akan dihapus
                !empty($photo) ? File::delete(public_path('uploads/product/' .$photo)) : null;

                //upload file menggunakan method saveFile()
                $photo = $this->saveFile($request->name, $request->file('photo'));
